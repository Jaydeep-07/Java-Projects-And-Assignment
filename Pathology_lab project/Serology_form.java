...
public class Serology_form extends JDialog implements  ActionListener 
{
	JLabel ltname,lpname,l1,l2,l3,l4,l5,l6;
    ...
    public Serology_form()
    {
    	setTitle("TEST SEROLOGY MONOTOX");
    	...
    	ltname= new JLabel("MONTOX TEST");
    	lpname= new JLabel("PATIENT NAME:");
    	l1= new JLabel("PPD GIVEN ON:");    t1= new JTextField(10);   
    	l2= new JLabel("READING ON:");      t2= new JTextField(10);
    	...
    	l2.setFont(f2);
    	l3.setBounds(50,200,200,100);         t3.setBounds(270,240,200,30);
    	l3.setFont(f2);
    	l4.setBounds(50,250,200,100);         t4.setBounds(270,290,200,30);
    	l4.setFont(f2);
    	...
    	if(ae.getActionCommand().equals("EXIT"))
    	{
     	...
     	if(ae.getActionCommand().equals("ADD"))
     	{
     		...
     		else
     		{
     		    ...
     		    {
     		      initialize();
     			  pst= con.prepareStatement("Insert into Test_Serology_Montoux values(?,?,?,?,?)");
     	      ...
     	      l1.setBounds(50,170,150,30);   l2.setBounds(50,220,150,30);  l3.setBounds(50,270,200,30);       	
    	      l4.setBounds(50,320,150,30); 
     		

     		   L1=new JLabel(t1.getText());  L1.setBounds(220,170,150,30); L1.setFont(f2);	     
     	       L2=new JLabel(t2.getText());  L2.setBounds(220,220,150,30); L2.setFont(f2);	     
     	       L3=new JLabel(t3.getText());  L3.setBounds(220,270,150,30); L3.setFont(f2);
     	       ...
     	       t4.setVisible(false);    list.setVisible(false);    b2.setVisible(false);
     	        ...
     	        lpname.setText("SEROLOGY MONTOUX ");
     	        lpname.setBounds(100,100,300,100);
     	        b1.setBounds(200,600,100,40);
     	        b1.setLabel("PRINT");
     	        
     	        cc.add(L1); cc.add(L2); cc.add(L3); cc.add(L4); 
