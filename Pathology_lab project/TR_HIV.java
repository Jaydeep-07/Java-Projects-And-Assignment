...
import java.sql.*;
 ...
 class TR_HIV extends JDialog
 {
	...
	public TR_HIV()
	{
		...
		JLabel lHeading= new JLabel("HIV I & II TEST RECORD");
		lHeading.setFont(f);
		lHeading.setBounds(100,8,550,60);
		cc.add(lHeading);
		
		String Tcol[] = {"Pname","Obeservation","Method"};  // Array of objects of String(Object type) class
	...
	public void initialize()
	{
		try
		{
			...
			rs1 = st1.executeQuery("Select * From Test_HIV");
		}	
		catch(Exception e)
		{
